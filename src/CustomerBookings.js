...
import AddReviewPopup from './AddReviewPopupForm';
...
function CustomerBooking() {
    ...
    const openPopup = (serviceproviderservicesidparm, isOpenParm = false) => {

        let tempPopupValues = {};
        tempPopupValues.serviceproviderservicesidvar = serviceproviderservicesidparm;
    ...
    return (
        ...
        <div>
            <h2 id="serprohead">My Booking</h2>
                ...
                <Paper>
                    <TableContainer component={Paper}>
                        <Table sx={{ minWidth: 700 }} stickyHeader aria-label="sticky table">
                            ...
                            <TableBody>
                                <CustomerBookingList StyledTableCell={StyledTableCell} eventdate = {eventdate} selectedStatus = {selectedStatus} openPopupForm = {openPopup}  />
                            </TableBody>
                        </Table>
                    </TableContainer>
            ...
            {showPopup && <AddReviewPopup  closePopup = {closePopup} serviceproviderservicesid = {popupvalues.serviceproviderservicesidvar}/>}
